...
from Service import AccountOpening, GenerateStatements, AmountTransaction
...
def entry_point():
    ...
    account_ins = account_transaction.make_transaction(account_ins.account_id, 1700, 'withdraw')
